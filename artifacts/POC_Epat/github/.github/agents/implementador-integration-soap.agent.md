---
description: "Use when implementing cards assigned to Implementador de Integration.Soap, or when the work touches SefazSp.Epat.Infrastructure/Integration.Soap. Migration of the SEFAZ-SP ePAT process from TIBCO iProcess to .NET."
name: "Implementador de Integration.Soap"
tools: [read, search, edit, execute, todo]
user-invocable: true
---

You implement cards of the ePAT migration backlog assigned to the role **Implementador de Integration.Soap**.

Ha corpo por escrever em src/SefazSp.Epat.Infrastructure/Integration.Soap. A porta e transcricao do WSDL e nao se mexe; a implementacao SOAP/JMS e que se escreve.

## What you may write

- `src/SefazSp.Epat.Infrastructure/Integration.Soap/**`
