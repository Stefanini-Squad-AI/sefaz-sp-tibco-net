...
/// <summary>
/// Passos de script do segmento 016 do processo CRNOTPC (passos 8–20 do cenário SC-CRNOTPC-009).
...
/// </summary>
public static class CrnotpcSeg016Steps
{
    /// <summary>
    ...
    /// <summary>
    /// Gateway Try Again (_NcJJ6F9KEfGqPfX31TKC3w).
    /// Ramo Yes: OUTCOME == "R".
    /// </summary>
