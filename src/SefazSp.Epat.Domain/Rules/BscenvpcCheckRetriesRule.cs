...
/// Regra de transição do gateway "Check Retries SW_QRETRYCOUNT" no processo BSCENVPC.
///
/// Expressão legada: IPESystemValues.SW_QRETRYCOUNT &lt; MAXRETRIES
/// Ramo verdadeiro ("Stillgood"): prossegue para Busca Envolvidos Vista Por AIIM.
...
/// </summary>
public static class BscenvpcCheckRetriesRule
{
    /// <summary>
    ...
    /// <returns>
    ///   <c>true</c>  → ramo "Stillgood" → Busca Envolvidos Vista Por AIIM<br/>
